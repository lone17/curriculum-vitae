...
\begin{xitemize}
    \item \textbf{Developing Knowledge-hub technologies for Insurance Domain.}
    \begin{zitemize}
...
\vspace{-.2em}
\begin{xitemize}
    \item \textbf{Worked on the Machine Learning Toolkit of the \href{https://www.i2g.cloud/well-insight}{Well Insight platform \faUpRightFromSquare}}
    \begin{zitemize}
