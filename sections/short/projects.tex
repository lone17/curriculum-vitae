\skills{\href{https://github.com/Cinnamon/kotaemon}{Kotaemon} (\textmd{24.5k+ \scriptsize \faStar}) - An open-source tool for
local RAG application. \hfill Jan 2024 --- May 2024}\\
\subtext{
    Open-source project, Co-creator
    \hfill
    \href{https://cinnamon.github.io/kotaemon/}{\faFile}
...
\subtext{
    Personal research
    \hfill
    \href{https://github.com/lone17/DECAF/blob/main/main.pdf}{\faFile}
...
\subtext{
    \href{https://challenge.zalo.ai}{Zalo AI Challenge 2018}
    \hfill
...
\begin{zitemize}
    ...
    \item \textbf{4th place} on the Private Leaderboard, achieved \textbf{79.208\%
        accuracy} in 10 days as an \textbf{individual participant}.
\end{zitemize}
